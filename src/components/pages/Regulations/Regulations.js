    ...
    return (
        <div className="regulations">
            ...
            <ol className="regulations__list">
                ...
                <li className="regulations__item">
                    <h4 className="regulations__heading">Phasellus ut nunc erat.</h4>
                    <p className="regulations__text">Phasellus ut nunc erat. Donec commodo nisl a mauris malesuada, id ornare enim tristique. Suspendisse malesuada justo quis lacinia dictum. Nulla lorem lacus, commodo non leo in, bibendum sagittis arcu. Ut pharetra, purus ullamcorper vestibulum ornare, sapien justo accumsan velit, eu finibus ex lectus a metus. Duis molestie magna vel ligula euismod, vitae ultrices dolor ultricies. Nunc eleifend eros in sem aliquam congue. Vivamus ultricies, nulla vitae tristique pellentesque, nisl lorem ultrices lorem, quis ullamcorper nunc odio ut neque. Integer nulla odio, porta at lacinia facilisis, porta ut lectus. Ut eu facilisis orci. Aliquam lacinia faucibus dictum. Cras ac orci lorem. Integer efficitur diam sed justo sollicitudin porttitor.</p>
                </li>
                <li className="regulations__item">
                    <h4 className="regulations__heading">Donec commodo nisl.</h4>
                    <p className="regulations__text">Etiam risus nisl, cursus sed viverra vitae, eleifend id justo. In hendrerit nulla et sapien volutpat bibendum vel gravida ante. Aliquam sapien mi, maximus vitae porta ut, suscipit commodo odio. Nam vitae tortor at ligula tempor tincidunt. Praesent ut venenatis nulla. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras mollis augue nisi, sed ultrices lorem dictum molestie. Aenean quis tempus mi. Duis laoreet ultricies augue, sit amet elementum ligula semper et. Curabitur nulla sapien, ullamcorper ut congue eu, vestibulum nec turpis. Suspendisse et auctor mi, at tempor metus. Curabitur vestibulum lorem ac orci rutrum commodo.</p>
                </li>
                <li className="regulations__item">
                    <h4 className="regulations__heading">Cras sagittis, augue quis.</h4>
                    <p className="regulations__text">Etiam metus odio, rhoncus tempor mollis id, finibus ac mi. Ut porta elementum tellus, et molestie ligula ultricies at. Mauris ullamcorper arcu in tortor rutrum, et vehicula ipsum pretium. Cras interdum in nunc sed finibus. Duis nisl ligula, ultricies vitae lorem porta, suscipit vestibulum ipsum. Phasellus sed augue non felis consequat pellentesque. Phasellus a convallis felis. Maecenas non lorem nec elit ultrices dignissim. Vestibulum eu molestie leo. Donec imperdiet nisl lorem, ac condimentum nunc vestibulum et. Etiam eget lorem felis. Morbi non ante ac nunc dictum condimentum. Ut massa magna, semper nec egestas in, consectetur non diam.</p>
                </li>
                <li className="regulations__item">
                    <h4 className="regulations__heading">Phasellus ut nunc erat.</h4>

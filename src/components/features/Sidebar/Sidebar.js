...
const Sidebar = ({sortAscend, sortDescend, sortAZ, sortZA, filterCategory, activeFilter, setActiveFilter, searchingText, handleTextChange, handleSearching, toggleActiveClassName, sidebarShow}) => {
